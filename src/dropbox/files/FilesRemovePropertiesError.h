...
namespace files{
    ...
    public:
        ...
        ///None
        LookUpPropertiesError getPropertyGroupLookup()const{API_CHECK_STATE((RemovePropertiesError_PROPERTY_GROUP_LOOKUP == m_tag), "expected tag: RemovePropertiesError_PROPERTY_GROUP_LOOKUP", m_tag);return m_property_group_lookup;};
