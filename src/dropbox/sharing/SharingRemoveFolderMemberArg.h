...
namespace sharing{
    ...
    public:
        ...
        const RemoveFolderMemberArg& setSharedfolderid(const QString& arg){m_shared_folder_id=arg; return *this;};

        ///The member to remove from the folder.
        MemberSelector member()const{return m_member;};
        const RemoveFolderMemberArg& setMember(const MemberSelector& arg){m_member=arg; return *this;};
        ...
        const RemoveFolderMemberArg& setLeaveacopy(const bool& arg){m_leave_a_copy=arg; return *this;};
