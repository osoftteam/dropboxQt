...
namespace sharing{
    ...
    public:
        ...
        ///None
        SharedFolderAccessError getAccessError()const{API_CHECK_STATE((RelinquishFolderMembershipError_ACCESS_ERROR == m_tag), "expected tag: RelinquishFolderMembershipError_ACCESS_ERROR", m_tag);return m_access_error;};
