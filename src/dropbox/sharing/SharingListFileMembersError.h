...
namespace sharing{
    ...
    public:
        ...
        ///None
        SharingUserError getUserError()const{API_CHECK_STATE((ListFileMembersError_USER_ERROR == m_tag), "expected tag: ListFileMembersError_USER_ERROR", m_tag);return m_user_error;};

        ///None
        SharingFileAccessError getAccessError()const{API_CHECK_STATE((ListFileMembersError_ACCESS_ERROR == m_tag), "expected tag: ListFileMembersError_ACCESS_ERROR", m_tag);return m_access_error;};
