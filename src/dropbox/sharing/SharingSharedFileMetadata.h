...
namespace sharing{
    ...
    public:
        ...
        const SharedFileMetadata& setPolicy(const FolderPolicy& arg){m_policy=arg; return *this;};

        ///The sharing permissions that requesting user has on this file. This corresponds to the entries given in :field:`GetFileMetadataBatchArg.actions` or :field:`GetFileMetadataArg.actions`.
        const std::list <FilePermission>& permissions()const{return m_permissions;};
        const SharedFileMetadata& setPermissions(const std::list <FilePermission>&& arg){m_permissions=arg; return *this;};
        ...
        const SharedFileMetadata& setOwnerteam(const users::Team& arg){m_owner_team=arg; return *this;};
        ...
        const SharedFileMetadata& setParentsharedfolderid(const QString& arg){m_parent_shared_folder_id=arg; return *this;};

        ///URL for displaying a web preview of the shared file.
        QString previewUrl()const{return m_preview_url;};
        const SharedFileMetadata& setPreviewurl(const QString& arg){m_preview_url=arg; return *this;};

        ///The lower-case full path of this file. Absent for unmounted files.
        QString pathLower()const{return m_path_lower;};
        const SharedFileMetadata& setPathlower(const QString& arg){m_path_lower=arg; return *this;};
        ...
        const SharedFileMetadata& setPathdisplay(const QString& arg){m_path_display=arg; return *this;};

        ///The name of this file.
        QString name()const{return m_name;};
        const SharedFileMetadata& setName(const QString& arg){m_name=arg; return *this;};

        ///The ID of the file.
        QString id()const{return m_id;};
        const SharedFileMetadata& setId(const QString& arg){m_id=arg; return *this;};
        ...
        const SharedFileMetadata& setTimeinvited(const QDateTime& arg){m_time_invited=arg; return *this;};
    ...
    public:
        ...
        static SharedFileMetadata EXAMPLE();
