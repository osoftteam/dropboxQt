...
namespace sharing{
    ...
    public:
        ...
        const AddFileMemberArgs& setFile(const QString& arg){m_file=arg; return *this;};
        ...
        const AddFileMemberArgs& setMembers(const std::list <MemberSelector>&& arg){m_members=arg; return *this;};

        ///Message to send to added members in their invitation.
        QString customMessage()const{return m_custom_message;};
        const AddFileMemberArgs& setCustommessage(const QString& arg){m_custom_message=arg; return *this;};

        ///Whether added members should be notified via device notifications of their invitation.
        bool quiet()const{return m_quiet;};
        const AddFileMemberArgs& setQuiet(const bool& arg){m_quiet=arg; return *this;};
        ...
        const AddFileMemberArgs& setAccesslevel(const AccessLevel& arg){m_access_level=arg; return *this;};
        ...
        const AddFileMemberArgs& setAddmessageascomment(const bool& arg){m_add_message_as_comment=arg; return *this;};
