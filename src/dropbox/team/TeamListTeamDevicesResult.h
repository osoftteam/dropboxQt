...
namespace team{
    ...
    public:
        ...
        ///If true, then there are more devices available. Pass the cursor to :route:`devices/list_team_devices` to retrieve the rest.
        bool hasMore()const{return m_has_more;};

        ///Pass the cursor into :route:`devices/list_team_devices` to receive the next sub list of team's devices.
    ...
    public:
        ...
        static ListTeamDevicesResult EXAMPLE();
